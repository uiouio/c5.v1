...
{
    public class AddrAssignInstruction : AbstractInstruction
    {
        public AddrAssignInstruction(AddrAssignCommand command, AddrAssign parameter)
            : base(command, parameter) { }

        public override string Name { get { return "AddAssign"; } }
        ...
        {
            var addrAssignInfo = parameter as AddrAssign;
            return new AddrAssignDataPacket(addrAssignInfo.DestinationAddr, addrAssignInfo.AddrChangeTo);
        }
